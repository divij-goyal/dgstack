...
Source: https://www.paulgraham.com/early.html
...
to your imagination  not just to have lower standards, but to switch polarity entirely, from listing
...
not when their predictions are weighted by outcome .
...
impulses because they're morally better. [ 1 ] The reason many hope
...
plagued with asterisks. [ 2 ] If you use revenue as the test, Silicon
...
rare, so if you have the opportunity to learn from one, take it. [ 3 ]
...
isn't what you wanted to learn. [ 7 ]
...
kept me going while I was working on Bel . Having worked for so long
...
that historically the Bay Area has attracted a different sort of person than,
...
be powerful  the idea of making the tenuousness and implausibility a feature . "Yes, it's a bit ridiculous, right? I'm just trying
