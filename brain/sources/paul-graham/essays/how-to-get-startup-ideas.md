...
across the entire population, and you have zero users. [ 2 ]
...
heard of? If you can't answer that, the idea is probably bad. [ 3 ]
...
investment. Especially if you're also looking for a cofounder. [ 4 ]
...
learning to hack is not necessary, it is for the foreseeable future
...
that these sites would have to be generated by software. [ 5 ]
...
shoulder, taking note of gaps and anomalies. [ 6 ]
...
might do better to get a summer job in some unrelated field. [ 8 ]
...
classes to attend because they're supposed to be studying for finals. [ 9 ]
...
it is to be something that could be turned into a startup. [ 10 ] I think the reason is that the subset of ideas that count as research
...
about the condition it induces, which I called schlep blindness .
...
sexy, you'll work on it more enthusiastically. [ 13 ]
...
startup idea while they were working at their day jobs. [ 15 ]
