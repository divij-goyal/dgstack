...
Source: https://www.paulgraham.com/web20.html
...
web as a platform," which I took to refer to web-based applications. [ 1 ]
...
And yet, oddly enough, Ryan Singel's article about the conference in Wired News spoke of "throngs of
...
market is gone. Venture investors are driven by exit strategies. The reason they were funding all
...
channel their efforts. Wikipedia may be the most famous. Experts have given Wikipedia middling
...
news. I never look at any news site now except Reddit . [ 2 ] I know if something major
...
of ideas, but their production. I've noticed for a while that the stuff I read on individual people's
...
the best in print. [ 3 ] And now that the web has evolved mechanisms
...
to raise VC-scale funding, and if they take it, they'll take it on their terms .
...
obvious what users wanted, so Apple flew under the labels. [ 4 ] Though really it might be better to describe iTunes as Web 1.5.
...
to MS Office. [ 5 ] Who will? Google? They seem to be taking their
...
Joe Kraus, the co-founder of Excite. [ 6 ]
...
with descriptive tokens. But there is also huge source of implicit tags that they ignore: the text within web links.
...
Disclosure: Reddit was funded by Y Combinator . But although
...
In Jessica Livingston's Founders at
