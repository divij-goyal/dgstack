...
We've now invested in enough companies that I've learned a trick
...
too slow to release stuff, and none because they were too quick. [ 1 ]
...
know they'll have to work a lot harder once they do. [ 2 ]
...
not one thing had changed. Wouldn't it start to seem lame? [ 3 ]
...
to assume you already knew what they did? For example, the corporate site that says the
...
does. [ 4 ] And not just to users. You need this for everyone:
...
the hope of good returns, but the fear of missing out. [ 6 ] So if
...
to take advantage of weakness. [ 8 ] So while they're often nice
...
drag on through your whole life. [ 9 ]
...
There are two ways to do work you love : (a) to make money, then work
