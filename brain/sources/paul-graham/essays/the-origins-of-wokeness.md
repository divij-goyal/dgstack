...
performativeness, not the social justice. [ 0 ]
...
for example? They were concerned with much the same issues. [ 1 ]
...
and that means the similarities were obvious. [ 3 ]
...
have to give him a long list of rules to memorize. [ 4 ]
...
make people uncomfortable too. [ 5 ]
...
first was the popularity of outrage. Users seemed to like being outraged. We're so used to this idea now that we take
...
mechanism for fanning the flames of wokeness. [ 7 ]
...
mostly an artifact of the constraints imposed by print. [ 8 ] When your market was determined by geography, you had
...
great narratives." [ 9 ] Meanwhile journalists, of a sort,
...
justification for their existence. [ 11 ] But these
...
breaking. So the cycle accelerates. [ 12 ]
...
by describing new improprieties it might be guilty of. [ 13 ]
...
right-wing ones, but without censoring either. [ 14 ] Consumers have emphatically rejected brands that ventured
...
the masses. [ 15 ] And we already have well-established
...
were to enforce Christian orthodoxy. Should we censor writers or scientists whose work contradicts woke doctrines?
...
to change what we're allowed to say. [ 17 ]
...
enforcers among them, the aggressively conventional-minded .
...
We can't get rid of the aggressively conventional-minded. [ 18 ] And we couldn't prevent people from creating new
...
informally, in passing in the middle of an article about a
...
the de facto parallel legal system established by Title IX
