...
Source: https://www.paulgraham.com/wisdom.html
...
your elementary school class to add all the numbers from 1 to 100? [ 1 ]
...
someone knows what to do because they have inside information. [ 3 ] But aside from that, I don't think we can get much more specific
...
do. Distinguishing between "wise" and "smart" is a modern habit. [ 5 ] And the reason we do is that they've been diverging. As knowledge
...
hadn't made enough progress. [ 8 ] The Chinese and Greek words we
...
goals. [ 9 ] In practice, it seemed as if there was a correct decision
...
In this world, wisdom seemed paramount. [ 10 ] Even now, most people
