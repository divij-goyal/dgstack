...
Source: https://www.paulgraham.com/worked.html
...
a stack of punch cards and then stopping. [ 1 ]
...
high end software. But Interleaf still had a few years to live yet. [ 5 ]
...
style, but it's usually why buyers pay a lot for such work. [ 6 ]
...
we did what's now called "doing things that don't scale ," although
...
in much the same way I was converted to fatherhood once I had kids.
...
Another thing I didn't get at the time is that growth rate is the
...
combined with Yahoo's prematurely aged culture and grim cube farm
...
applications for them? [ 9 ] You could run all sorts of services
...
she decided to compile a book of interviews with startup founders.
...
work for it, and we'd get Robert and Trevor as partners too. [ 13 ]
...
wouldn't have known where to start. [ 14 ]
...
the perfect source. [ 15 ] We got 225 applications for the Summer
...
the founders free air conditioners. [ 16 ]
...
at least completely engaging. [ 18 ]
...
the next few months. I even wrote a couple that weren't about
...
is an answer to that question. [ 19 ]
...
comes with the territory. An essay must tell readers things they don't already know , and some
