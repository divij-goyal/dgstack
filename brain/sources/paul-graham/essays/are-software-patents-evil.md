...
Source: https://www.paulgraham.com/softwarepatents.html
...
first time, realizing with shock that the players were deliberately bumping into one another, and deciding that one would on no account
...
are, their patents probably haven't issued yet. [ 3 ] Nor do startups,
...
abilities. [ 4 ] A patent seems to change the balance. It gives the
...
including the experts themselves, can measure. [ 5 ]
...
programs to compete with Microsoft Word. [ 6 ] They build Writely.
...
not true. The American way is to make money by creating wealth , not by suing people. [ 7 ] What companies like Forgent do is actually the proto-industrial
...
go so far, but the movie industry has already tried to pass laws prescribing three year prison terms just for putting movies on
