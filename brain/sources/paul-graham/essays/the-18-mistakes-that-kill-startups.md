...
ideas without involving yourself. What would be a great idea for someone else to do as a startup?
...
solve them. [ 2 ] What do people complain about? What do you wish there was?
...
One reason to launch quickly is that it forces you to actually finish some quantum of work. Nothing is truly finished till it's
...
you understand best are your own. [ 4 ]
...
to the next step, whatever that is. [ 5 ] Fortunately you have some
...
time required to raise money grows with the amount. [ 7 ] When the
...
how to create wealth (= how much people want something x the number
...
Can you imagine anything more painful for a hacker? [ 10 ] But it
