...
Source: https://www.paulgraham.com/fr.html
...
you try to raise money before you can convince investors, you'll not only waste your time, but also burn your
...
for long. An early stage startup grows mostly because the founders make it grow, and if the founders look away,
...
quickly and get back to work. [ 2 ]
...
at a good valuation, you can take that without having to think. [ 3 ] The terms will be whatever they turn out to be in your next
...
you're not in fundraising mode, because that's fundraising. [ 4 ] Tell them politely; tell them you're focusing on the company right
...
in fundraising mode. Deals don't happen that way. [ 5 ] But even
...
investors they respect. [ 7 ] The next best type of intro is from a
...
parallel, but give higher priority to the more promising ones. [ 10 ]
...
such questions. [ 13 ] If you're not, there's a trick you can use
...
at this and ask how their process works and where you are in it. [ 14 ]
...
investor will say yes, but the probability that they'd be the first to say yes, and the latter is not simply a constant fraction of the
...
to mean they won't invest unless you can raise more elsewhere.) [ 17 ]
...
the solution I recommend for pitching your startup: do the right thing and then just tell investors what
...
a position of strength without being profitable. [ 19 ]
...
won't invest in at a cap of $x will have an easier time at $x/2. [ 20 ]
...
as you combine it with the next one. [ 21 ]
...
algorithm tells you what to do. [ 23 ]
...
founder(s) from the details of the process. [ 25 ]
...
over lunch at a nice restaurant. [ 26 ]
...
usual that pride goeth before a fall. [ 27 ]
