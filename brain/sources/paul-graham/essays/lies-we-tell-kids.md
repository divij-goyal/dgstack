...
Source: https://www.paulgraham.com/lies.html
...
school into keeping quiet or move their kids to a new school.
...
deceived by the state through lies: it was a crushing impression. [ 2 ]
...
kids to say and one forbidden? The only explanation is: by definition. [ 3 ]
...
differentiate themselves by believing. [ 5 ]
...
and the useful half is the payload. [ 6 ]
...
book written to teach them about "issues." [ 7 ] Peter Mayle wrote
...
never only one person's fault. [ 8 ]
...
it has some kind of spin to put on it. Much recent history consists of spin. It would probably be better just to teach them metafacts
