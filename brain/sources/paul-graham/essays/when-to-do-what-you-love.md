...
something about it. It's like a puzzle for them. [ 1 ]

In fact there's an edge case here so spectacular that it turns all

the preceding advice on its head. If you want to make a really huge amount of money — hundreds of millions or even billions of dollars
...
like, or how well you could do them. [ 2 ]
...
genuinely interested in it, and that will make it extra inspiring. [ 3 ]
