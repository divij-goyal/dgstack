...
Source: https://www.paulgraham.com/ideas.html
...
That might seem a stupid thing to ask. Why do they think it's hard? If people can't do it, then it is hard, at least
...
knows that if you tried this you'd be able to make something useful. Maybe what you'd end up with wouldn't even be a spreadsheet.
...
be of the same sex, and if one group is a minority in some population, pairs of them will be a minority squared. [ 1 ]
...
also related, in the sense that hackers and painters are both makers ,
...
what they should be doing, and do it yourself. Even if
