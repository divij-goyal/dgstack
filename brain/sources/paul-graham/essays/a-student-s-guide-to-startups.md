...
Source: https://www.paulgraham.com/mit.html
...
A year and a half ago I gave a talk where I said that the average age of the founders of
...
startup founders, getting rich. [ 1 ] About a month into each funding
...
When we first started Y Combinator we encouraged people to start
...
Nebraska. Places that aren't startup hubs are toxic to startups.
...
who are not just smart, but incurable builders . Look
...
will nail you first. Between t = 0 and when you buy that yacht, someone is going to ask if any of your code legally belongs

to anyone else, and you need to be able to say no. [ 3 ]
...
if it would be a net win for you to leave. [ 4 ]
...
a book of interviews with startup founders, and I noticed a remarkable pattern in them.
...
sometimes help you discover new ideas. Steve Wozniak put this very strongly:
