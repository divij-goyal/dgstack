...
Source: https://www.paulgraham.com/publishing.html
...
depended mostly on the format? Why didn't better content cost more? [ 1 ]
...
because (a) many of the customers are businesses, who get in trouble if they use pirated versions, and (b) though in form merely
...
players. The optimal ways to make money from the written word
...
home. [ 3 ] Or maybe the movie business will dry up, and the people

working in it will go to work for game developers.

I don't know how big embodying information in physical form will

be. It may be surprisingly large; people overvalue physical stuff .
...
ingenuity of individual publishers. [ 4 ]
...
The reason I've been writing about existing forms is that I don't know what new forms will appear. But though I can't predict
